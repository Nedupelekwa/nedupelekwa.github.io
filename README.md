...
<section id="certifications">
  ...
  <div class="cert-grid reveal">
    ...
    <div class="cert-card"><div class="cert-stripe"></div><div class="cert-preview"><img src="images/DA Associate - Twitter - Post.png" alt="Certified Associate Data Analyst" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><div class="cert-preview-placeholder" style="display:none"><span class="cert-preview-icon">&#9678;</span><span class="cert-preview-label">Certificate Preview</span></div><div class="cert-preview-overlay"><span>View Certificate &#8599;</span></div></div><div class="cert-body"><div class="cert-title">Certified Associate Data Analyst</div><div class="cert-issuer">DataCamp</div><a href="https://www.datacamp.com/completed/statement-of-accomplishment/track/285094eba0c487a0fcf11f88f024f7f512bb3609" target="_blank" class="cert-view-link green-link">View Certificate &#8599;</a></div></div>
    <div class="cert-card"><div class="cert-stripe"></div><div class="cert-preview"><img src="images/Associate Data Analyst In SQL.jpg" alt="Data Analyst In SQL" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><div class="cert-preview-placeholder" style="display:none"><span class="cert-preview-icon">&#9678;</span><span class="cert-preview-label">Certificate Preview</span></div><div class="cert-preview-overlay"><span>View Certificate &#8599;</span></div></div><div class="cert-body"><div class="cert-title">Data Analyst In SQL Certificate</div><div class="cert-issuer">DataCamp</div><a href="https://drive.google.com/file/d/1dz-DwS6HYnoymkwOesF9GP3GXoMAMQ5T/view?usp=drive_link" target="_blank" class="cert-view-link green-link">View Certificate &#8599;</a></div></div>
