...
<section class="hero" id="hero">
  ...
  <div class="hero-inner">
    ...
    <div class="hero-content">
      ...
      <p class="hero-title">Data Analyst | Business Intelligence Professional</p>
...
<section id="skills">
  ...
  <div class="skills-grid reveal">
    ...
    <div class="skill-block"><div class="skill-block-icon">▣</div><div class="skill-block-title">Spreadsheets & Productivity</div><div class="skill-tags"><span class="tag accent-tag">MS Excel</span><span class="tag accent-tag">Google Sheets</span><span class="tag">Google Forms</span><span class="tag">Power Query</span></div></div> class="tag">Google Workspace</span></div></div>
    ...
    <div class="skill-block"><div class="skill-block-icon">◯</div><div class="skill-block-title">Cloud & Platforms</div><div class="skill-tags"><span class="tag accent-tag">Google Cloud</span><span class="tag">BigQuery</span><span
